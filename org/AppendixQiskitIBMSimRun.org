...
#+export_file_name: ./html/AppendixQiskitIBM.html
...
- We define a circuit in Listing [[lst:AerSimCkt]]
  ...
  : /var/folders/88/d26ncvp97zg50164_cmmlyf511m8tn/T/babel-bmQJhU/python-kdqTaU:5: DeprecationWarning: The method ``qiskit.circuit.instructionset.InstructionSet.c_if()`` is deprecated as of qiskit 1.3.0. It will be removed in 2.0.0.
  :   qc.h(0).c_if(0,1) # apply a X gate to qubit 0 if classical bit 1 is 1
